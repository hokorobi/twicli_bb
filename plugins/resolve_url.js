...
(function(){
    var re = /^https?:\/\/(t\.co|tinyurl\.com|bit\.ly|is\.gd|u\.nu|icio\.us|tr\.im|cli\.gs|twurl\.nl|url\.ie|j\.mp|ow\.ly|ff\.im|digg\.com|dlvr\.it|buff\.ly|po\.st|(?:www\.)?tumblr\.com|tmblr\.co|htn\.to|goo\.gl|slidesha\.re|amzn\.to|ustre\.am|ift\.tt|fb\.me|urx\.nu|wp\.me|on\.fb\.me|pocket\.co|getpocket\.com|feedly\.com|db\.tt|pin\.it|cro\.st|www\.crowsnest\.tv|smar\.ws|www\.smartnews\.com|npx\.me)\/|http:\/\/p\.tl\/(?!.\/)/;
